<template>
    <vue-dropzone ref="myVueDropzone" id="myVueDropzone" :class="'upload-zone dropzone dz-clickable'" :include-styling=false :useCustomSlot=true :options="dropzoneOptions">
